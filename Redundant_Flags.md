These flags (amonh others) are enabled by default on Adoptium and GraalVM Java 17 CE/EE.
...
Many of the `dgraal` options are rednant as well, but these are left in for ease of testing in case one of the compiler options breaks a mod. 
