These flags are enabled by default on Adoptium and GraalVM Java 17 CE/EE.
...
They will be removed from the GraalVM flags, but I will leave them in the "general" Java flags, as not all Java distributions enable them all. 
