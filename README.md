...
- `-XX:AllocatePrefetchStyle=3` Generate one prefetch instruction per cache line instead of per allocation(1). It seems to break ZGC, hence its only enabled for G1GC.
